# 🌟 Hi, I'm Wei Zhong (PengWeizhong) 👋

专注 **Java / Spring / 动态 SQL / 音乐可视化** 的开发者。 喜欢把“能用”的东西打磨成“优雅、可维护、有温度”的工具。
...
- **补强 MyBatis**：让动态 SQL 更强、更结构化
- **保持 SQL 主导**：你仍然写 SQL，只是写得更舒服
- **类型安全**：字段、表名、条件都可类型检查
- **可组合**：复杂 SQL 可以像积木一样拼装

### 🔧 特性亮点

- 多数据源 & 多 Schema
- 动态表名、动态字段、动态条件
- 插件化 ValueParser / AttributeConverter / SqlErrorHint / DbSchemaMatcher
